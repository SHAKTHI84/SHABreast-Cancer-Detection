...
SECRET_KEY = 'django-insecure-^rm-=pq3=kjn&*fbs9n=igcms-4on3@cfz#-fp(n+_dt^h87uq'
...
INSTALLED_APPS = [
    ...
    'detection.apps.DetectionConfig',  # Add this line
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'detection/templates')],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
